    ...
    <div name="about" className="w-full h-screen bg-[#0a192f] text-white">
      <div className="flex flex-col items-center justify-center w-full h-full">
        ...
        <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4 mt-4">
          ...
          <div
            className="flex items-center text-sm tracking-wide text-gray-300 md:text-lg "
            data-aos="fade-right"
            data-aos-delay="400"
          >
            <div className="flex-col items-center">
              ...
              <p className="mt-4 md:mt-8 text-base md:text-xl text-[#EAD196] font-semibold tracking-wider">
